            ...
            steps {
                timestamps {
                    script {
                        ...
                        returnCode = utils.cmd("runner xunit --settings tools/vrunner.json ${platform1cLine} --ibconnection \"${testbaseConnString}\" ${admin1cUsrLine} ${admin1cPwdLine} --pathvanessa tools/add/xddTestRunner.epf")
